...
class StatisticController extends Controller
{
	...
	public function actionIndex()
	{
		...
		if(isset($_GET['Keywords'])||isset($_GET['Statistic'])){
			$model->attributes=array_merge(isset($_GET['Statistic'])?$_GET['Statistic']:array(), 
					                       isset($_GET['Keywords'])?$_GET['Keywords']:array());
		}
